...
Example:
    ...
    python batch_process_raw.py ./raw_data ./processed_data --signal-processor ./signal_processing_mimo.py

    python batch_process_raw.py -v ../../../Pilot2_MIMO/F1_MIMO_train_raw ../../../Pilot2_MIMO/F1_MIMO_test_processed
    python batch_process_raw.py -v ../../../Pilot2_MIMO/F2_MIMO_train_raw ../../../Pilot2_MIMO/F2_MIMO_test_processed
"""
...
Examples:
  ...
  python batch_process_mat_files.py ./raw_data ./processed_data --signal-processor ./signal_processing.py
    ...
    parser.add_argument(
        "--signal-processor",
        default="signal_processing_mimo.py",
        help="Path to signal processing script (default: signal_processing_mimo.py in current directory)"
    )
    ...
    for i, input_file in enumerate(mat_files, 1):
        ...
        if success:
            ...
            if args.verbose and error:
                print(f"    Error: {error[:10000]}")  # Print first 200 chars of error
            exit(1)
