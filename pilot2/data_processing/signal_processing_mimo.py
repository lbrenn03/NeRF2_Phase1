...
Usage:
    python signal_processing_mimo.py --input raw_capture.mat --output processed_capture.mat
"""
...
parser.add_argument('--input',  default='../F1_MIMO_train_raw/mimo_tx1_0_0_0.mat', help='Input .mat file')
