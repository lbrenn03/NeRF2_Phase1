...
parser.add_argument('--input',  default='demo.mat', help='Input .mat file')
...
plot_constellations(all_syms_ant1_S1_f, all_syms_ant2_S1_f, range(num_pkts_S1), 'S1')
plot_constellations(all_syms_ant1_S2_f, all_syms_ant2_S2_f, range(num_pkts_S2), 'S2')
