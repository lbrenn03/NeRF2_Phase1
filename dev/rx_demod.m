...
if x_lab >= 0
    foldername = 'pilot_data/tx_13_8/x-' + string(x_lab);
    mkdir(foldername);
    filename = foldername + '/nerf_' + string(x_lab) + '_' + string(y_lab) + '.mat'
else
    foldername = 'pilot_data/tx_13_8/x-n1';
    mkdir(foldername);
    filename = foldername + '/nerf_n1_' + string(y_lab) + '.mat'
end
